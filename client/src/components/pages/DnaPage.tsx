                ...
                <div className="flex flex-col justify-center h-full">
                  <div>
                    <h6 className="mb-5 text-4xl font-medium tracking-tight font-heading">
                      What percentage of pit bull DNA would you use to classify
                      a dog as a pit bull?
                    </h6>
                    <p className="mb-5 text-xl text-neutral-700 font-medium">
                      Adjust the slider to select the percentage of "pit bull"
                      DNA that you would use to consider a dog a pit bull. The
                      system includes a 10% courtesy buffer, meaning that if a
                      dog is 40% pit bull and you selected 50% in the slider,
                      your answer will be deemed correct because it falls within
                      the 10% buffer range.
                    </p>
                    <div className="mb-2">
                      <Slider
