          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap -m-8">
              ...
              <div className="w-full md:w-2/3 p-8">
                ...
                <p className="text-xl mt-3 font-medium mb-20 max-w-3xl text-neutral-400">
                  If you have any questions that are not answered in our FAQ,
                  please feel free to{" "}
                  <a href="mailto: banthisbreed@gmail.com"> contact us.</a> We
